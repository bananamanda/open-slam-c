...
#define MAX_RANGE 	30.0 		// m
#define DT_OBSERVE	8*DT_CONTROLS	// seconds
...
#define NUMBER_LOOPS 	2			// num loops

/* resampling */
#define NPARTICLES 	100
#define NEFFECTIVE 	0.75 * NPARTICLES

#define SWITCH_CONTROL_NOISE 	1
#define SWITCH_SENSOR_NOISE	1
